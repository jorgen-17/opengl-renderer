...
case "$OS" in
    ...
    Darwin)
        ...
        ADD_LD_FLAGS="-lglew -lassimp -L/opt/homebrew/lib -lglfw ./common/3rdparty/meshoptimizer/build/libmeshoptimizer.a -framework Cocoa -framework OpenGL -framework IOKit"
        ;;
    *)
        echo "Unknown OS: $OS"
        ;;

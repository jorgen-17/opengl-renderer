...
#ifndef LEGACY_LIGHTING_TECHNIQUE_H
#define LEGACY_LIGHTING_TECHNIQUE_H
...
class LegacyLightingTechnique : public Technique
{
public:
...
#endif  /* LEGACY_LIGHTING_TECHNIQUE_H */
